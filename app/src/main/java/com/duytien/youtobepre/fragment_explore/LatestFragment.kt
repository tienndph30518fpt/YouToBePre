...
private lateinit var adapter: MultiTypeAdapter
    override fun onCreateView(
      ...
      val view = inflater.inflate(R.layout.fragment_latest, container, false)
        recyclerView = view.findViewById(R.id.recyclerLatestFragment)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listContent = listOf(
            ...
            PlayData(R.drawable.load_mipmap, "phim việt nam", "CHUNG CỰC BÚT KÝ - Tập 34 | Siêu Phẩm Phim Hành Động Thám Hiểm Cực Hot | iQIYI Phim Thuyết Minh",
                "100 video"),
            ...
            PlayData(R.drawable.load_mipmap, "phim Mỹ", "Tây du ký - Tập 34 | Siêu Phẩm Phim Hành Động Thám Hiểm Cực Hot | iQIYI Phim Thuyết Minh",
                "100 video"),
            VideoData(R.drawable.load_mipmap, "00:00:00", R.drawable.load_mipmap,
                "CHUNG CỰC BÚT KÝ - Tập 34 | Siêu Phẩm Phim Hành Động Thám Hiểm Cực Hot | iQIYI Phim Thuyết Minh",
                "iQIYI Phim Thuyết Minh"),
        )
        adapter = MultiTypeAdapter(listContent)
